...
export default function StudentPage() {
  ...
  const handleAtsAnalyze = async () => {
    ...
    try {
      ...
      console.error(err);
      setAtsError(
        "Unable to get ATS score. Please ensure the backend service is available."
      );
    } finally {
      setAtsLoading(false);
    }
  ...
  return (
    <div className="sd-layout">
      ...
      <div className="sd-header-wrap">
        ...
        <header className="sd-nav">
          ...
          <div className="sd-nav-right">
            <Link href="/student/profile" className="sd-nav-link">
              Profile
            </Link>
            <button
      ...
      <div className="sd-content">
        ...
        <div className="sd-sidebar">
          <div className="sd-promo-card-premium">
            ...
            <button
              className="sd-promo-btn-premium-solid"
            ...
            <div style={{ marginTop: "0.75rem" }}>
              <button
                className="sd-promo-btn-premium-outline"
            ...
            <div style={{ marginTop: "0.75rem" }}>
              <button
                className="sd-promo-btn-premium-gold"
              ...
              <div className="sd-application-list">
                {appliedJobs.map((job) => (
                  ...
                  >
                    ...
                    <div className="sd-application-status-chip">
                      {getApplicationStatusLabel(applicationsByJob[job.id]?.status)}
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div key={job.id} className="sd-job-card">
                  ...
                  >
                    <div className="sd-job-date-row">
                      <span className="sd-job-date">
                        {new Date(job.createdAtDate).toLocaleDateString("en-GB", {
                          day: "numeric",
                          month: "short",
                          year: "numeric",
                        })}
                  ...
                  <div className="sd-job-bottom">
                    <div className="sd-job-bottom-left">
                      <div className="sd-job-location" style={{ marginTop: "auto" }}>
      ...
      {isAtsModalOpen && (
        <div className="sd-modal-overlay">
          <div className="sd-modal">
            <button className="sd-modal-close" onClick={() => setIsAtsModalOpen(false)}>
              ×
            </button>
            <h2>ATS Analyzer</h2>
            ...
            <div className="sd-form-group">
              ...
              <input
                ...
                style={{ padding: "0.5rem 0", color: "#e5eef8" }}
              />
            </div>
      ...
      {isUploadResumeModalOpen && (
        <div className="sd-modal-overlay">
          <div className="sd-modal">
            ...
            <h2>Upload Resume</h2>
            <p style={{ marginBottom: "1.5rem", color: "var(--ad-muted)" }}>
              Upload your resume to your profile to quickly apply to jobs.
            </p>
            <div className="sd-form-group">
              <input
                type="file"
                onChange={handleResumeUpload}
                style={{ padding: "1rem 0", color: "var(--ad-text)" }}
              />
            </div>
          </div>
        </div>
      ...
      {isPaymentModalOpen && (
        <div className="sd-modal-overlay">
          <div className="sd-modal">
            <button className="sd-modal-close" onClick={() => setIsPaymentModalOpen(false)}>
              ×
            </button>
            <h2>Upgrade to Premium</h2>
            <p style={{ marginBottom: "1.5rem", color: "var(--ad-muted)" }}>
              Unlock unlimited job applications and advanced ATS resume scanning tools.
            </p>
            <div
              style={{
                padding: "2rem",
      ...
      {isAppModalOpen && selectedApplication && (
        <div className="sd-modal-overlay">
          <div className="sd-modal" style={{ maxWidth: "700px" }}>
            <button className="sd-modal-close" onClick={() => setIsAppModalOpen(false)}>
              ×
            </button>
            <div
              className="sd-job-logo"
              style={{ width: "60px", height: "60px", fontSize: "1.5rem", marginBottom: "1rem" }}
            >
              {selectedApplication.job.companyName
                ? selectedApplication.job.companyName.charAt(0).toUpperCase()
                : "C"}
            </div>
            <h2 style={{ margin: "0.5rem 0 0.25rem 0" }}>{selectedApplication.job.title}</h2>
            <p style={{ color: "var(--ad-cyan)", fontWeight: "600", marginBottom: "1rem" }}>
              {selectedApplication.job.companyName}
            </p>
            ...
            <div style={{ display: "flex", gap: "1rem", marginBottom: "1.5rem", flexWrap: "wrap" }}>
              ...
              <span className="sd-job-tag">Full time</span>
              <div
                className="sd-application-status-chip"
            ...
            <div style={{ marginTop: "2rem", display: "flex", justifyContent: "flex-end" }}>
              <button className="btn-secondary" onClick={() => setIsAppModalOpen(false)}>
                Close
              </button>
            </div>
          </div>
